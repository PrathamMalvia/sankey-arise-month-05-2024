        ...
        <section className="w-full md:w-4/5 mx-auto my-8 px-4 overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row gap-4">
                <article className="relative w-full md:w-1/2 h-64 md:h-80 lg:h-96 rounded-lg overflow-hidden">
                    <img src={mk1} alt="Highly reviewed travel offers" className="w-full h-full object-cover" />
                ...
                <article className="relative w-full md:w-1/2 h-64 md:h-80 lg:h-96 rounded-lg overflow-hidden">
                    <img src={mk2} alt="New Year's celebration in New York City" className="w-full h-full object-cover" />
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4">
